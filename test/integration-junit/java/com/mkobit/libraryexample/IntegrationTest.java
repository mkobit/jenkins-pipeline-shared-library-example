...
class IntegrationTest {
  ...
  void parameterizedProjectUsesDefaultAndOverriddenValues(JenkinsRule rule) throws Exception {
    ...
    var boolParam = new BooleanParameterDefinition("myBoolean", false, "boolean parameter description");
    var choiceParam = new ChoiceParameterDefinition("myChoice", new String[]{"choice1", "choice2"}, "choice parameter description");
    ...
    WorkflowRun withParams = rule.assertBuildStatusSuccess(
