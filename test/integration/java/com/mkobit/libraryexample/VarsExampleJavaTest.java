...
/**
 * Demonstrates using Jenkins integration tests with plain Java and JUnit 4. Compiled from
 * test/integration/java/ to show the plugin supports Java-only consumers alongside Groovy-based
 * tests.
 */
public class VarsExampleJavaTest {
  ...
  public void jenkinsApiTypesAreAvailableOnClasspath() {
    Assert.assertNotNull(Item.class);
  }
}
